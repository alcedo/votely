// Template helper to display loading spinner
Template.shelfDisplay.dbSyncReady = function(){
    return Session.get('isAllCollectionLoaded'); 
}

// showShelfItems Template Helper
Template.showShelfItems.helpers({
